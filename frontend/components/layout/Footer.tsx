        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-sm text-neutral-300">
              AI-powered DeFi onboarding and risk management platform. 
              Learn, practice, and navigate DeFi safely with personalized guidance.
            </p>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.product.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-sm leading-6 text-neutral-300 hover:text-white transition-colors"
                      >
                        {item.name}
                      </Link>
                    </li>
        ...
        <div className="mt-12 border-t border-neutral-700 pt-8">
          <div className="flex flex-col items-center justify-between sm:flex-row">
            <p className="text-xs leading-5 text-neutral-400">
              &copy; 2024 Aya DeFi Navigator. All rights reserved.
            </p>
